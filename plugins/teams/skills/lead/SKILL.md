...
| `bd export` | Lead (session end) |

**Sync flow:** `bd ready` at session start to find work, create team tasks from bead items, `bd close` after team delivers, `bd export` before cleanup.
